...
const setUpDatabase = async () => {
    try {
        await initialPool.query("DROP DATABASE IF EXISTS food_review_system;");
        await initialPool.query("CREATE DATABASE food_review_system;");
...
export {initialPool, setUpDatabase};